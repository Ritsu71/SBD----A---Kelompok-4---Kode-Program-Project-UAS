...
if (isset($_POST['login'])) {
    $email_pelanggan = $_POST['user'];
    $password_pelanggan = $_POST['pass'];

    $query = "SELECT * FROM pelanggan WHERE email_pelanggan='$email_pelanggan' AND password_pelanggan='$password_pelanggan'";
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="./vendor/hambu/hamburgers.min.css">
    <link rel="stylesheet" type="text/css" href="./vendor/pilih2/select2.min.css">
        ...
        <div class="container-login100">
            <div class="wrap-login100">
                <div class="login100-pic js-tilt" data-tilt="">
                    <img src="./assets/images/find_user.jpg" alt="IMG">
                </div>
                <form class="login100-form validate-form" method="POST" action="login.php">
                    ...
                    <script src="./vendor/tilt.jquery.min.js"></script>
                    <script>
                    $('.js-tilt').tilt({
                        scale: 1.1
                    })
